...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        text: '简介',
        items: [
          { text: '什么是 openZetc？', link: '/intro/project-overview' },
          { text: '快速开始', link: '/intro/quick-start' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/TomPrestonWernerp/openZetcWeb' }
    ],

    footer: {
      message: '本项目基于 MIT License 开源，欢迎使用和贡献。',
      copyright: 'Copyright © 2025-present openZetc'
    },

    editLink: {
      pattern: 'https://github.com/TomPrestonWernerp/openZetcWeb/edit/main/docs/:path',
      text: '在 GitHub 上编辑此页'
    },
