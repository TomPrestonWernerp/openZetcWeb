...
const GITHUB = 'https://github.com/TomPrestonWernerp/openZetcWeb'
  ...
  <div class="yx-home">
    ...
    <section class="yx-hero">
      ...
      <div class="yx-container yx-hero__inner">
        ...
        <h1 class="yx-hero__title">语析 <span class="yx-accent">openZetc</span></h1>
    ...
    <section class="yx-section">
      <div class="yx-container">
        <header v-reveal class="yx-head">
          ...
          <p class="yx-head__sub">openZetc 内置一套完整的 Harness——沙盒、技能、工具、子智能体与中间件，让智能体真正动手完成任务。</p>
        </header>
        <div class="yx-bento">
          <article
...
git clone --branch v0.7.1 --depth 1 https://github.com/TomPrestonWernerp/openZetcWeb.git
cd openZetcWeb && ./scripts/init.sh
    ...
    <section class="yx-section yx-section--soft">
      <div class="yx-container yx-center">
        ...
        <a v-reveal :href="GITHUB + '/graphs/contributors'" target="_blank" rel="noreferrer" class="yx-contrib">
          <img src="https://contrib.rocks/image?repo=TomPrestonWernerp/openZetcWeb&max=60&columns=12" alt="openZetc 贡献者头像墙" loading="lazy" />
        </a>
