...
def _ensure_metadata_loaded():
    ...
    from openzetc.agents.toolkits.registry import (
...
def get_tool_instances_by_category(category: str) -> list[Any]:
    from openzetc.agents.toolkits.registry import get_all_extra_metadata, get_all_tool_instances
...
async def resolve_configured_runtime_tools(context) -> list[Any]:
    ...
    from openzetc.agents.middlewares.skills import resolve_skill_gated_tools
