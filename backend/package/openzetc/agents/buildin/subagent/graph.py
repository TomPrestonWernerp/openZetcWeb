...
from openzetc.agents import BaseAgent, BaseState, load_chat_model, resolve_chat_model_spec
from openzetc.agents.backends import create_agent_filesystem_middleware
from openzetc.agents.buildin.chatbot.prompt import TODO_MID_PROMPT, build_prompt_with_context
from openzetc.agents.buildin.subagent.context import SubAgentContext
from openzetc.agents.context import (
    ...
    DEFAULT_OPENZETC_SUMMARY_PROMPT,
    prepare_agent_runtime_context,
)
from openzetc.agents.middlewares import (
...
async def _build_middlewares(context):
    ...
    summary_prompt = getattr(context, "summary_prompt", None) or DEFAULT_OPENZETC_SUMMARY_PROMPT
