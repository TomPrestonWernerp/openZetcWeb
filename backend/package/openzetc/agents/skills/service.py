...
from openzetc import config as sys_config
from openzetc.agents.mcp.service import get_enabled_mcp_server_slugs
from openzetc.agents.skills.repository import SkillRepository
from openzetc.storage.postgres.models_business import Skill, User
from openzetc.services.rbac_service import get_user_permission_map, has_permission
from openzetc.utils.logging_config import logger
from openzetc.utils.share_config import SHARE_ACCESS_LEVELS, normalize_share_config
...
async def prepare_remote_skill_install(
    ...
    *,
    ...
    from openzetc.agents.skills.remote_install import prepare_remote_skills_batch
