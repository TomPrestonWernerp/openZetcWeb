...
from openzetc.knowledge.utils.kb_utils import resolve_processing_params
...
from openzetc.utils import hashstr, logger
...
class MilvusKB(KnowledgeBase):
    ...
    def _current_connection_settings(self) -> dict[str, str]:
        ...
        return {
            ...
            "name": str(settings.get("name") or "openzetc"),
        }
    ...
    def _get_embedding_function(self, embedding_model_spec: str, *, sync: bool = False):
        ...
        from openzetc.models.embed import select_embedding_model
    ...
    async def aquery(self, query_text: str, kb_id: str, agent_call: bool = False, **kwargs) -> list[dict]:
        ...
        try:
            ...
            try:
                from openzetc.models.rerank import get_reranker
