...
from openzetc.knowledge.chunking.ragflow_like.presets import ensure_chunk_defaults_in_additional_params
from openzetc.knowledge.schemas import (
    FindOutputSchema,
    FindWindowSchema,
    SearchOutputSchema,
    SearchResultSchema,
)
from openzetc.knowledge.utils import resolve_processing_params, sanitize_processing_params
...
from openzetc.utils.datetime_utils import coerce_any_to_utc_datetime, utc_isoformat
...
class KnowledgeBase(ABC):
    ...
    async def _persist_kb(self, kb_id: str, record_fields: dict[str, Any] | None = None) -> None:
        ...
        if record_fields:
            allowed_fields = {"share_config", "created_by", "department_id"}
