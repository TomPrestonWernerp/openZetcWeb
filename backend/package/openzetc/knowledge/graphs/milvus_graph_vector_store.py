...
from openzetc.knowledge.graphs.graph_utils import graph_entity_collection_name, graph_triple_collection_name
...
class MilvusGraphVectorStore:
    ...
    def _init_connection(self) -> None:
        ...
        self.milvus_db = str(settings["name"] or "openzetc")
