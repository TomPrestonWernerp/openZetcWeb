...
from openzetc.knowledge.parser.base import BaseDocumentProcessor, DocumentParserException
from openzetc.knowledge.parser.zip_utils import process_zip_file_sync
