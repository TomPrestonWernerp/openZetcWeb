...
from openzetc.storage.postgres.models_business import Base as BusinessBase
from openzetc.storage.postgres.models_knowledge import Base as KnowledgeBase
from openzetc.utils import logger
from openzetc.utils.singleton import SingletonMeta
...
class PostgresManager(metaclass=SingletonMeta):
    ...
    async def ensure_business_schema(self):
        ...
        self._check_initialized()
        stmts = [
            "ALTER TABLE IF EXISTS users ADD COLUMN IF NOT EXISTS name VARCHAR(50)",
            (
