...
from openzetc.agents.backends import create_agent_composite_backend
...
from openzetc.agents.skills.service import normalize_string_list
from openzetc.services.agent_runtime_service import resolve_thread_agent_runtime_context
...
from openzetc.utils.datetime_utils import utc_isoformat_from_timestamp
from openzetc.utils.paths import VIRTUAL_PATH_OUTPUTS, VIRTUAL_PATH_UPLOADS, VIRTUAL_PATH_WORKSPACE
...
def _preview_binary_response(path: str, raw_content: bytes, preview_type: str) -> StreamingResponse:
    ...
    headers = {
        ...
        "X-openZetc-Preview-Filename": quote(file_name),
    }
