...
from openzetc.config import config as sys_config
from openzetc.repositories.agent_run_repository import TERMINAL_RUN_STATUSES, AgentRunRepository
from openzetc.services.chat_service import stream_agent_chat, stream_agent_resume
from openzetc.services.input_message_service import restore_chat_input_message
from openzetc.services.run_queue_service import (
...
from openzetc.storage.postgres.models_business import Message, User
from openzetc.storage.redis import get_arq_redis_settings
from openzetc.utils.logging_config import logger
from openzetc.utils.thread_utils import extract_thread_id
...
def _map_chunk_to_run_event(chunk: dict) -> tuple[str, dict]:
    ...
    if status == "agent_state":
        return "custom", {"name": "openzetc.agent_state", "chunk": chunk, "agent_state": chunk.get("agent_state") or {}}
